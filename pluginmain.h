...
//plugin data
#define PLUGIN_NAME "BreakModule"
...
extern char dExeName[MAX_PATH];

typedef struct _stBreakInfo{
	char module[MAX_MODULE_SIZE];
	char active[10];
} stBreakInfo;

extern TList *lstBreakInfo;
extern TXMLDocument *xmlFile;
const char *configFileName = "breakmodule.cfg";
